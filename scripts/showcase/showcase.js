import { CANVAS_HEIGHT, CANVAS_WIDTH, context, generateSimplex, mouseCoordinates } from "../globals.js";
...
export default class MarchingSquaresDemo{
    ...
    reDrawPoints(deltaTime){
        this.verticies = [];
        this.grid = this.generateGrid({x:20, y:20}, CANVAS_WIDTH, 50, deltaTime);
